...
class RequestsCombinePSBTRequest(object):
    ...
    def __init__(self, psbts=None):  # noqa: E501
        """RequestsCombinePSBTRequest - a model defined in Swagger"""  # noqa: E501
        self._psbts = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestsCombinePSBTRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestsCombinePSBTRequest):
            return False
