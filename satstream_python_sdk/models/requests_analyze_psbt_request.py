...
class RequestsAnalyzePSBTRequest(object):
    ...
    def __init__(self, psbt=None):  # noqa: E501
        """RequestsAnalyzePSBTRequest - a model defined in Swagger"""  # noqa: E501
        self._psbt = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RequestsAnalyzePSBTRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestsAnalyzePSBTRequest):
            return False
