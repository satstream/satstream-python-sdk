...
> InlineResponse20019 get_mempool_ancestors(body)
...
> InlineResponse20020 get_mempool_descendants(body)
...
# **get_mempool_info**
> InlineResponse20021 get_mempool_info()
...
# **get_raw_mempool**
> InlineResponse20022 get_raw_mempool(body)
...
# **test_mempool_accept**
> InlineResponse20023 test_mempool_accept(body)
